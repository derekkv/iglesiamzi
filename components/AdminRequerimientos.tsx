        ...
        if (solicitante.phone) {
          authFetch("/api/whatsapp/send", {
            method: "POST", body: JSON.stringify({
              phone: formatPhoneForWhatsApp(solicitante.phone),
              message: waMsg,
              origen: "requerimiento",
              useCase: "aviso_requerimiento",
              templateData: { destinatario: solicitante.displayName || "", solicitante: "Administración", detalle: waMsg.slice(0, 300) },
            }),
          }).catch(() => {})
        }
