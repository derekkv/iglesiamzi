...
export const TABLE_ACCESS_MAP: Record<string, TableAccess> = {
  ...
  nomina: {
    modules: ["flujo_pago", "control_mensual", "resumen-pastoral"],
  },
  payment_tables: {
    modules: ["flujo_pago"],
  },
  ...
  alfoli: {
    modules: ["administracion", "control_mensual", "presupuesto_anual", "resumen-pastoral"],
  },
  ofrendas_celulas: {
    modules: ["ofrenda-celulas", "celulas", "control_mensual", "presupuesto_anual", "resumen-pastoral"],
  },

  // === GESTIÓN DE CÉLULAS ===
  gestion_celulas: {
    modules: ["celulas", "ofrenda-celulas", "control_mensual", "resumen-pastoral"],
  },
  miembros_celulas: {
    modules: ["celulas"],
  },
  ...
  gestion_atrasados: {
    modules: [
      ...
      "gestion-cronogramas", "control_mensual", "resumen-pastoral"],
  },
  ...
  censo_archivos: {
    modules: ["censo", "censo-mdg", "censo-jovenes-mdg", "censo-jovenes-protocolo"],
    requireEditForWrite: false,
  },
  censo_mdg_archivos: {
    modules: ["censo-mdg", "censo", "censo-jovenes-mdg", "censo-jovenes-protocolo"],
    requireEditForWrite: false,
  },
  censo_mdg: {
  ...
  bautizos: {
    modules: ["bautizo", "control_mensual", "resumen-pastoral"],
  },
  bautizos_manual: {
    modules: ["bautizo"],
  },
  matrimonios: {
    modules: ["matrimonio", "control_mensual", "resumen-pastoral"],
  },
  matrimonios_manual: {
    modules: ["matrimonio"],
  },
  presentacion_ninos: {
    modules: ["presentacion-ninos", "listados", "control_mensual", "resumen-pastoral"],
  },
  ...
  // === DISCIPULADO ===
  discipulado_ciclos: {
    modules: ["discipulado_primeros_pasos", "discipulado_seguimos_avanzando", "discipulado_siendo_iglesia", "historial_discipulado", "listados", "control_mensual", "resumen-pastoral"],
  },
  ...
  proyecto_mario_ciclos: {
    modules: ["proyecto_mario_belleza_integral_sabados", "proyecto_mario_belleza_integral_viernes", "proyecto_mario_manualidades", "proyecto_mario_belleza_cejas", "proyecto_mario_gastronomia", "historial_proyecto_mario", "listados", "control_mensual", "resumen-pastoral"],
  },
  ...
  reporte_incidencias_herederos: {
    modules: ["reporte_incidencias_herederos", "herederos_baby", "herederos_kids", "herederos_explores", "herederos_champions"],
    requireEditForWrite: true,
  },
  ...
  // === PAGO DIARIO ===
  pago_diario: {
    modules: ["pago_diario", "ingresos_egresos", "control_mensual"],
  },
  ...
  // === COMUNICACIONES: WHATSAPP CLOUD API ===
  // wa_config NO se lista aquí a propósito: contiene el access_token y el
  // app_secret de Meta, y solo debe leerse con service_key desde API routes.
  wa_config: {
    modules: [], // Inaccesible desde el cliente
  },
  wa_contacts: {
  ...
  wa_messages: {
    modules: ["comunicaciones"],
    requireEditForWrite: false, // el agente marca leído / registra desde la UI
    requireAdminForDelete: true,
  },
  wa_templates: {
    modules: ["comunicaciones"],
  ...
  // email_config contiene SMTP_PASS e IMAP_PASS → solo service_key.
  email_config: {
    modules: [], // Inaccesible desde el cliente
  },
  email_messages: {
    modules: ["comunicaciones"],
    requireEditForWrite: false, // marcar leído / destacado desde la bandeja
    requireAdminForDelete: true,
  },
  email_attachments: {
    modules: ["comunicaciones"],
