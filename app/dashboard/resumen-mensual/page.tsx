...
function ResumenMensualContent({ canEdit }: { canEdit: boolean }) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-xl font-semibold text-gray-900">Resumen Mensual</h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        {/* Tarjetas de resumen superiores */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {/* Total Miembros {CHURCH.initials} (suma de todos) */}
                ...
                <CardContent className="pt-5 pb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-[9px] text-lime-600">entregados este mes · {statsRedil.pendientes} pendientes</p>
                    </div>
                ...
                <CardContent className="pt-5 pb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-[9px] text-fuchsia-600">{statsCumpleanos.enviados} felicitados · {statsCumpleanos.pendientesEnvio} pendientes</p>
                    </div>
                ...
                <CardContent className="pt-5 pb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xl font-bold text-violet-700">{statsEventos.reduce((s, e) => s + e.inscritos, 0)}</p>
                      <p className="text-[9px] text-violet-600">inscritos · {statsEventos.length} evento(s) activo(s)</p>
                    </div>
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <CardContent className="pt-5 pb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xl font-bold text-cyan-700">{Object.values(statsServidores).reduce((s, v) => s + v.asistieron, 0)}</p>
                      <p className="text-[9px] text-cyan-600">asistieron · {Object.values(statsServidores).reduce((s, v) => s + v.faltaron, 0)} faltaron</p>
                    </div>
              ...
              <Card className="border-purple-200 bg-purple-50/50 cursor-pointer hover:shadow-md transition-shadow" onClick={() => setModalAsistenciaCulto(true)}>
                <CardContent className="pt-5 pb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-xs text-purple-700">Asistencia al Culto</p>
                      <p className="text-xl font-bold text-purple-700">{statsAsistenciaCulto.asistieron}</p>
                      <p className="text-[9px] text-purple-600">{statsAsistenciaCulto.faltaron} faltaron · {statsAsistenciaCulto.enSeguimiento} seguimiento</p>
                      {statsAsistenciaCulto.sinGestionar > 0 && (
                        <p className="text-[9px] text-red-600">{statsAsistenciaCulto.sinGestionar} sin gestionar</p>
                      )}
                    </div>
          ...
          <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2 text-green-700">
                <TrendingUp className="w-5 h-5" /> Ingresos del Mes
              </DialogTitle>
              <DialogDescription>Total: ${totalIngresos.toLocaleString("es-CO", { minimumFractionDigits: 2 })} · {ingresos.length} registros</DialogDescription>
            </DialogHeader>
            <div className="space-y-3">
              {ingresos.map((ing, i) => (
              ...
              {ingresos.length === 0 && <p className="text-center text-gray-500 py-4">No hay ingresos registrados</p>}
            </div>
          ...
          <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2 text-red-700">
                <TrendingDown className="w-5 h-5" /> Egresos del Mes
              </DialogTitle>
              <DialogDescription>Total: ${totalEgresos.toLocaleString("es-CO", { minimumFractionDigits: 2 })} · {egresos.length} registros</DialogDescription>
            </DialogHeader>
            <div className="space-y-3">
              {egresos.map((eg, i) => (
              ...
              {egresos.length === 0 && <p className="text-center text-gray-500 py-4">No hay egresos registrados</p>}
            </div>
            <Button className="w-full mt-4" onClick={() => router.push("/dashboard/ingresos-egresos")}>
              <ExternalLink className="w-4 h-4 mr-2" /> Ir a Ingresos/Egresos
            </Button>
          ...
          <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2 text-purple-700">
                <Users className="w-5 h-5" /> Asistencia Total del Mes
              </DialogTitle>
              ...
              {asistenciaDetails.map((row, i) => (
                <div key={i} className="p-3 bg-purple-50 rounded-lg">
                  ...
                  <div className="grid grid-cols-3 gap-2 mt-2">
                    {asistenciaColumns.map((col: any, j: number) => {
                      const val = asistenciaData.find((d: any) => d.fila_id === row.id && d.columna_id === col.id)?.valor || 0
                      return (
                        <div key={j} className="text-center p-1 bg-white rounded">
                          <p className="text-xs text-gray-500">{col.nombre}</p>
                          <p className="font-semibold text-purple-700">{val}</p>
                        </div>
                      )
                    })}
                  </div>
        ...
        {/* Modal Total Miembros {CHURCH.initials} */}
        <Dialog open={modalTotalMiembros} onOpenChange={setModalTotalMiembros}>
          <DialogContent className="max-w-lg">
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2 text-indigo-700">
                <img src={CHURCH.logoUrl} alt={CHURCH.initials} className="w-5 h-5" /> Total Miembros {CHURCH.initials}
              </DialogTitle>
            ...
            <div className="space-y-3">
              <div className="flex justify-between p-3 bg-indigo-50 rounded">
                <span>Censo Protocolo</span>
                <span className="font-bold text-indigo-700">{statsCenso.total}</span>
              </div>
              <div className="flex justify-between p-3 bg-amber-50 rounded">
                <span>Censo Niños</span>
                <span className="font-bold text-amber-700">{statsCensoNinos.total}</span>
              </div>
              <div className="flex justify-between p-3 bg-pink-50 rounded">
                <span>Censo Jóvenes</span>
                <span className="font-bold text-pink-700">{statsCensoJovenes.total}</span>
              </div>
              <div className="flex justify-between p-3 bg-violet-50 rounded">
                <span>Censo MDG</span>
                <span className="font-bold text-violet-700">{statsCensoMdg.total}</span>
              </div>
              <div className="flex justify-between p-4 bg-indigo-100 rounded-lg border-2 border-indigo-300">
                <span className="font-bold">TOTAL IRDD</span>
                <span className="font-bold text-xl text-indigo-800">{statsCenso.total + statsCensoMdg.total + statsCensoNinos.total + statsCensoJovenes.total}</span>
              </div>
            </div>
          </DialogContent>
        </Dialog>
        ...
        <Dialog open={modalCensoNinos} onOpenChange={setModalCensoNinos}>
          <DialogContent className="max-w-lg">
            <DialogHeader>
              ...
              <DialogDescription>Total: {statsCensoNinos.total} niños registrados</DialogDescription>
            </DialogHeader>
            <div className="space-y-3">
              <div className="flex justify-between p-3 bg-pink-50 rounded">
                <span>Baby (0-2 años)</span>
                <span className="font-bold text-pink-700">{statsCensoNinos.baby}</span>
              </div>
              <div className="flex justify-between p-3 bg-blue-50 rounded">
                <span>Kids (3-5 años)</span>
                <span className="font-bold text-blue-700">{statsCensoNinos.kids}</span>
              </div>
              <div className="flex justify-between p-3 bg-green-50 rounded">
                <span>Explores (6-8 años)</span>
                <span className="font-bold text-green-700">{statsCensoNinos.explores}</span>
              </div>
              <div className="flex justify-between p-3 bg-purple-50 rounded">
                <span>Champions (9-11 años)</span>
                <span className="font-bold text-purple-700">{statsCensoNinos.champions}</span>
              </div>
            </div>
            <Button className="w-full mt-4" onClick={() => router.push("/dashboard/censo-ninos")}>
              <ExternalLink className="w-4 h-4 mr-2" /> Ir a Censo Niños
            </Button>
          </DialogContent>
        </Dialog>
        ...
        <Dialog open={modalCensoJovenes} onOpenChange={setModalCensoJovenes}>
          <DialogContent className="max-w-lg">
            ...
            <div className="space-y-3">
              <div className="flex justify-between p-3 bg-pink-50 rounded">
                <span>Total Jóvenes</span>
                <span className="font-bold text-pink-700">{statsCensoJovenes.total}</span>
              </div>
              <div className="flex justify-between p-3 bg-pink-50 rounded">
                <span>Miembros</span>
                <span className="font-bold text-pink-700">{statsCensoJovenes.miembros}</span>
              </div>
              <div className="flex justify-between p-3 bg-pink-50 rounded">
                <span>Activos</span>
                <span className="font-bold text-pink-700">{statsCensoJovenes.activos}</span>
              </div>
              <div className="flex justify-between p-3 bg-green-50 rounded">
                <span>Nuevos este mes</span>
                <span className="font-bold text-green-700">{statsCensoJovenes.nuevosMes}</span>
              </div>
            </div>
            <Button className="w-full mt-4" onClick={() => router.push("/dashboard/censo-jovenes")}>
              <ExternalLink className="w-4 h-4 mr-2" /> Ir a Censo Jóvenes
            </Button>
          </DialogContent>
        </Dialog>
        ...
        <Dialog open={modalNuevosCreyentes} onOpenChange={setModalNuevosCreyentes}>
          <DialogContent className="max-w-lg">
            ...
            <div className="space-y-3">
              <div className="flex justify-between p-3 bg-violet-50 rounded">
                <span>Total Nuevos Creyentes</span>
                <span className="font-bold text-violet-700">{statsCensoMdg.nuevosCreyentes}</span>
              </div>
              <div className="flex justify-between p-3 bg-green-50 rounded">
                <span>Este mes</span>
                <span className="font-bold text-green-700">{statsCensoMdg.nuevosMes}</span>
              </div>
              <div className="flex justify-between p-3 bg-blue-50 rounded">
                <span>Hoy</span>
                <span className="font-bold text-blue-700">{statsCensoMdg.nuevosHoy}</span>
              </div>
            </div>
            <Button className="w-full mt-4" onClick={() => router.push("/dashboard/censo-mdg")}>
              <ExternalLink className="w-4 h-4 mr-2" /> Ir a Censo MDG
            </Button>
          </DialogContent>
        </Dialog>
          ...
          <DialogContent className="max-w-lg">
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2 text-sky-700">
                <GraduationCap className="w-5 h-5" /> Discipulado
              </DialogTitle>
                ...
                <div key={tipo} className="p-3 bg-sky-50 rounded">
                  ...
                  <div className="grid grid-cols-3 gap-2 mt-2 text-center">
                    <div className="bg-white p-2 rounded">
                      ...
                      <p className="font-bold text-sky-700">{statsDiscipulado[tipo].inscritos}</p>
                    </div>
                    <div className="bg-white p-2 rounded">
                      <p className="text-xs text-gray-500">En curso</p>
                      <p className="font-bold text-amber-600">{statsDiscipulado[tipo].enCurso}</p>
                    </div>
                    <div className="bg-white p-2 rounded">
                      <p className="text-xs text-gray-500">Aprobados</p>
                      <p className="font-bold text-green-600">{statsDiscipulado[tipo].aprobados}</p>
                    </div>
                  </div>
                </div>
              ))}
            </div>
            <Button className="w-full mt-4" onClick={() => router.push("/dashboard/discipulado")}>
              <ExternalLink className="w-4 h-4 mr-2" /> Ir a Discipulado
            </Button>
          </DialogContent>
        </Dialog>
          ...
          <DialogContent className="max-w-lg">
            ...
            <div className="space-y-3">
              <div className="flex justify-between p-3 bg-teal-50 rounded">
                <span>Total Bautizados (censo)</span>
                <span className="font-bold text-teal-700">{statsBautizos.censoBautizados}</span>
              </div>
              <div className="flex justify-between p-3 bg-green-50 rounded">
                <span>Bautizos este mes</span>
                <span className="font-bold text-green-700">{statsBautizos.esteMes}</span>
              </div>
            </div>
            <Button className="w-full mt-4" onClick={() => router.push("/dashboard/bautizos")}>
              <ExternalLink className="w-4 h-4 mr-2" /> Ir a Bautizos
            </Button>
          </DialogContent>
        </Dialog>
          ...
          <DialogContent className="max-w-lg">
            ...
            <div className="space-y-3">
              <div className="flex justify-between p-3 bg-rose-50 rounded">
                <span>Total Matrimonios (censo)</span>
                <span className="font-bold text-rose-700">{statsMatrimonios.censoMatrimonios}</span>
              </div>
              <div className="flex justify-between p-3 bg-green-50 rounded">
                <span>Matrimonios este mes</span>
                <span className="font-bold text-green-700">{statsMatrimonios.esteMes}</span>
              </div>
            </div>
            <Button className="w-full mt-4" onClick={() => router.push("/dashboard/matrimonios")}>
              <ExternalLink className="w-4 h-4 mr-2" /> Ir a Matrimonios
            </Button>
          </DialogContent>
        </Dialog>
        ...
        <Dialog open={modalCelulas} onOpenChange={setModalCelulas}>
          <DialogContent className="max-w-lg">
            ...
            <Button className="w-full mt-4" onClick={() => router.push("/dashboard/celulas")}>
              <ExternalLink className="w-4 h-4 mr-2" /> Ir a Células
            </Button>
          </DialogContent>
        </Dialog>
...
export default function ResumenMensualPage() {
  return (
    <PermissionsGuard moduleName="control_mensual">
      {(canEdit) => <ResumenMensualContent canEdit={canEdit} />}
    </PermissionsGuard>
  )
}
