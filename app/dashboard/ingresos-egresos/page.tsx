  ...
  useEffect(() => {
    const initializePage = async () => {
      try {
        ...
        if (!currentMonth) {
          router.push("/dashboard/resumen-mensual");
          return;
        }
